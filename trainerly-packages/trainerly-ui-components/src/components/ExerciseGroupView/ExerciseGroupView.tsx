...
export interface ExerciseGroupViewProps<T extends BaseExercise = BaseExercise> {
  exercises: T[];
...
interface MuscleGroupData<T extends BaseExercise = BaseExercise> {
  name: string;
  exercises: T[];
  count: number;
}

const ExerciseGroupView = <T extends BaseExercise = BaseExercise>({
  exercises,
  renderExerciseCard
